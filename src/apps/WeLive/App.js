...
class WeLive extends Component {
    ...
    state = {
        ...
        user: {
            ...
            role: "live",
            name: "live-"+Janus.randomString(4),
            username: null,
        },
        users: {},
        visible: true,
            ...
            <div className="vclient" >
                <div className="vclient__toolbar">
                    ...
                    <Menu icon='labeled' secondary size="mini">
                        ...
                        {!mystream ?
                            <Button attached='right' size='huge' positive loading={delay} icon='sign-in' disabled={delay || !selected_room} onClick={this.joinRoom} />:""}
                    </Menu>
