...
const onProtocolData = (data,user,ondata) => {
    ...
    if (what === "message") {
        ...
        if(json.participants) {
            ...
            if (shidur) {
                Janus.log(":: Shidur " + (shidur ? "Online" : "Offline") + " ::");
                ondata({type: "event", shidur: shidur.username === SHIDUR_ID})
            }
        }
    } else if (what === "join") {
        // Somebody joined
        ...
        if (username === SHIDUR_ID && user.id === SHIDUR_ID) {
            Janus.log(":: Support Enter ::");
            ondata({type: "event", shidur: true})
        }
        ...
        if (username === SHIDUR_ID && user.id === SHIDUR_ID) {
            ...
            ondata({type: "event", shidur: false})
        }
    } else if (what === "kicked") {
        // Somebody was kicked
